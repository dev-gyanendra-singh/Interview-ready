...
public class ExpenseService {
    public Expense createExpense(String description, double amount, User paidBy, List<Split> splits, ExpenseType type) {
        ...
        return new Expense(description, amount, paidBy, splits, type);
    }
}